...
"@
    ...
    if (Test-Path $ConfigPath) {
        Write-Host "⚠️  .wslconfig already exists at $ConfigPath" -ForegroundColor Yellow
    ...
    Write-Host "✨ Done! You can now launch Takumi Enterprise." -ForegroundColor Green

} catch {
    Write-Host "❌ Error: $($_.Exception.Message)" -ForegroundColor Red
}

# [Fix] ウィンドウをすぐに閉じないように待機する
Read-Host "Press Enter to exit..."